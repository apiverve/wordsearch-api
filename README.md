...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/wordsearch](https://docs.apiverve.com/ref/wordsearch)

---

## Use Cases

Common use cases for the Word Search Generator API:
