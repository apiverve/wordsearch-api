# Word Search Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:wordsearch-api:1.1.12'
}
```
...
```java
import com.apiverve.wordsearch.WordSearchGeneratorAPIClient;
import com.apiverve.wordsearch.APIResponse;
import com.apiverve.wordsearch.APIException;

// Initialize the client
WordSearchGeneratorAPIClient client = new WordSearchGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/wordsearch](https://docs.apiverve.com/ref/wordsearch)
...
- **Documentation:** [https://docs.apiverve.com/ref/wordsearch](https://docs.apiverve.com/ref/wordsearch)
- **Issues:** [GitHub Issues](https://github.com/apiverve/wordsearch-api/issues)
