...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/wordsearch";
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WordSearchGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WordSearchGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WordSearchGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(WordSearchGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WordSearchGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WordSearchGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WordSearchGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WordSearchGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WordSearchGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WordSearchGeneratorQueryOptions options)
        {
