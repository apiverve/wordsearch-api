...
const (
	baseURL        = "https://api.apiverve.com/v1/wordsearch"
	defaultTimeout = 30 * time.Second
)

// Client is the Word Search Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Word Search Generator API client.
...
// Execute makes a request to the Word Search Generator API with typed parameters.
//
